...
public final class PizzaOrder {
    ...
    //constructors for the order info
    public PizzaOrder() {
        clearOrder();
    }
    ...
    //switch statement for pizza size
    ...
    private void calculateTotalCost() {
        ...
        //if statement for pizza size with toppings
        total = sizeCost;
        if (cheeseSelected) {
            total += CHEESE_COST;
        }
